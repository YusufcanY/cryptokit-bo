import { Typography, Box, Skeleton, Alert, Card, CardContent } from '@mui/material';
...
const EthereumIcon = (props: any) => (
  <svg width="24" height="24" viewBox="0 0 320 512" fill="currentColor" {...props}>
...
export default function Home() {
  ...
  const PriceCard = ({ title, price, icon: Icon, color }: { title: string, price: number | undefined, icon: any, color: string }) => (
    <Card 
      sx={{ 
        height: '100%', 
        display: 'flex', 
